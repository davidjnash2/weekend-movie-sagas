...
// GET to retrieve movie title, poster path, description, and all
// attached genres for specific/specified movie using id of clicked 
// movie poster on MovieListItem component
